...
const BuildProcessTimeline = () => {
  ...
  /* Scroll-based line growth (SAME AS PRODUCT TIMELINE) */
      ...
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto mt-4">
            Seamless integration followed by rigorous real-world validation.
          </p>
        </motion.div>
        ...
        >
          ...
          {buildSteps.map((step, index) => (
            ...
            >
              ...
              <div
                className={cn(
                  "standard-card p-8 w-full md:w-5/12",
                  index % 2 === 0
