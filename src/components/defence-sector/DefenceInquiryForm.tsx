      ...
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        ...
        >
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            What defence teams achieve with MLXWORKX.
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Reduced uncertainty, better quality control, and systems designed for
...
export default DefenceInquiryForm;