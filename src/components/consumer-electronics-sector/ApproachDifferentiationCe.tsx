...
const FeatureCard = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      {/* STANDARDIZED HOVER GLOW WRAPPER */}
      <div className="card-hover-glow h-full">
        <div className="bg-card p-8 rounded-3xl border border-accent/30 shadow-lg h-full flex flex-col transition-transform duration-300">
...
const ApproachDifferentiationCe = () => {
  return (
    <section className="bg-secondary py-24 md:py-32 border-t border-accent/20">
