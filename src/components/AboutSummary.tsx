    ...
    <section className="bg-secondary py-24 md:py-32 rounded-t-[3rem] md:rounded-t-[6rem] border-t border-accent/20">
      <div className="container mx-auto px-4 md:px-8 max-w-6xl">
        ...
        >
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto font-semibold text-foreground">
            MLXWORKX is a Manufacturing Services Platform.
          </p>

          <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto mt-4">
            We move beyond just providing a service to embodying an entity
            dedicated to transforming manufacturing.
          </p>
        </motion.div>
          ...
          {values.map((value, index) => (
            ...
            >
              <div className="flex flex-col items-center">
                <div className="w-14 h-14 bg-accent/20 text-accent rounded-full mb-4 flex items-center justify-center">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Our goal: To humanize the brand and show the mission behind the
          technology.
        </motion.p>
