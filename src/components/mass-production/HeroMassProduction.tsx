    ...
    <section className="relative min-h-[80vh] flex items-center justify-center bg-background text-foreground p-4 overflow-hidden rounded-b-[3rem] md:rounded-b-[6rem] border-b border-accent/20">
      ...
      >
        ...
        <motion.h1
          ...
          viewport={{ once: true }}
        >
          Take your product to scale. Deliver with confidence.
        </motion.h1>

        {/* Description */}
        <motion.p
          className="text-lg md:text-xl lg:text-2xl font-medium mb-8 max-w-3xl mx-auto opacity-90"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            From{" "}
            <span className="font-bold text-primary">vendor chaos</span> to{" "}
            <span className="font-bold text-primary">data-driven execution</span>.
            Our system ensures production remains predictable, even at high volumes.
          </p>
        </motion.div>
      </motion.div>
    </section>
