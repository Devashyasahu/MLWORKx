...
const EvInquiryForm = () => {
  return (
    <section
      id="inquiry-form"
      className="bg-background text-foreground py-24 md:py-32 rounded-b-[3rem] md:rounded-b-[6rem] relative z-0 border-b border-[var(--ev-accent)]/20"
    >
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        ...
        >
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            What EV teams achieve with MLXWORKX.
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Faster transition to production, improved quality control, and
